...
That's it. One command installs the `rustyclaw` binary to `~/.cargo/bin/` with everything built in — queue processor, Discord bot, Telegram bot, and heartbeat monitor.
